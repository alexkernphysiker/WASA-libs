...
const MathTemplates::LorentzVector<> Get4Vector(const particle_kine&data);
const MathTemplates::LorentzVector<> Get4Vector(const std::vector<particle_kine>&data);
struct particle_kinp{Particle particle; double P,theta,phi;};
const MathTemplates::LorentzVector<> Get4Vector(const particle_kinp&data);
const MathTemplates::LorentzVector<> Get4Vector(const std::vector<particle_kinp>&data);
#endif
